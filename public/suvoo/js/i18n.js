...
const I18N = {
  en: {
    ...
    '支持运单号或订单号 · 扫描枪自动回车 · 手动输入后按': 'Tracking or order no. · scanner auto-Enter · after typing press',
  ...
  it: {
    ...
    '支持运单号或订单号 · 扫描枪自动回车 · 手动输入后按': 'N. spedizione o ordine · scanner auto-Invio · a mano premi',
