/* ============================================================
   ...
   ============================================================ */
const LANG_KEY = ((typeof window !== 'undefined' && window.SUVOO_NS) || '') + 'suvoo_lang';
...
const I18N = {
  en: {
    ...
    '已直接完成出库：{no}': 'Shipped directly: {no}',
    ...
    '单件订单确认尺寸': 'Confirm dims on single-item orders',
    '单件订单扫单后确认长宽高重再出库，并按 SKU 记忆（下次自动带出）。关闭则扫单直接出库': 'Single-item orders confirm L/W/H/weight before shipping, remembered per SKU (auto-filled next time). Off = ship on scan.',
    '尺寸已知时一扫即发': 'Ship on scan when size is known',
    '需先开启上一项。已记过尺寸的老 SKU 扫单直接出库不停顿，只有新 SKU 才停下来填尺寸': 'Requires the option above. SKUs with a saved size ship on scan without stopping; only new SKUs pause to enter size.',
    '尺寸已知，已直接出库：{no}': 'Size known — shipped directly: {no}',
    '新订单响铃提醒': 'New-order sound alert',
    '同步收到别处新下的待发订单时循环响铃 + 顶部提醒条，点「接单」后停；本机自己导入的不提醒': 'When new orders placed elsewhere arrive via sync, ring repeatedly + show a top banner until you Accept; orders you import here do not alert.',
    '有 {n} 个新订单待接单': '{n} new order(s) waiting to accept',
    '全部接单': 'Accept all',
    '查看': 'View',
    '静音': 'Mute',
    '已静音': 'Muted',
    '收到 {n} 个新订单，请接单': '{n} new order(s) received — please accept',
    '已接单：{no}': 'Accepted: {no}',
    '接单': 'Accept',
    '待接单': 'To accept',
    '单件出库 · 请确认尺寸重量': 'Single-item · confirm size &amp; weight',
    '↑ 已带出该商品上次尺寸，如有变化直接改（确认后覆盖记录）': '↑ Loaded this item\'s last size; edit if changed (overwrites on confirm)',
    '↑ 请在上方填写该商品尺寸重量，确认后记到该商品': '↑ Fill in this item\'s size &amp; weight above; saved to the item on confirm',
    '确认出库': 'Confirm &amp; ship', '放弃': 'Cancel',
    '已带出该商品上次尺寸，确认或修改后点「确认出库」': 'Loaded last size — confirm or edit, then Confirm & ship',
    '请填写该商品尺寸重量，点「确认出库」保存': 'Enter size & weight, then Confirm & ship to save',
    '已出库并记住该商品尺寸：{no}': 'Shipped and size saved for this item: {no}',
    '已放弃，未出库': 'Cancelled — not shipped',
    '请先点「确认出库」或「放弃」处理当前包裹': 'Confirm or cancel the current package first',
    ...
    '连接后可在此选择打印机和缩放模式（直接下发助手，无需改文件）。点上方「测试连接」加载。': 'After connecting, pick the printer and scale mode here (sent to the agent, no file editing). Click “Test connection” above to load.',
    '打印机': 'Printer', '缩放模式': 'Scale mode', '（系统默认打印机）': '(system default printer)',
    '原尺寸（最清晰）': 'Original size (sharpest)', '适配居中': 'Fit &amp; center', '超出缩小': 'Shrink if oversized',
    '保存到打印助手': 'Save to print agent', '没读到打印机列表（可留系统默认）': 'No printers detected (system default is fine)',
    '打印机设置已保存': 'Printer settings saved', '保存失败，请确认助手在运行': 'Save failed — make sure the agent is running',
    '连不上助手，无法加载打印机列表。请先点「测试连接」确认助手在运行。': 'Cannot reach the agent to load printers. Click “Test connection” first.',
    ...
    // —— 物流分拣台 ——
    '物流分拣': 'Carrier Sort', '物流分拣台': 'Carrier Sorting Station',
    '选定交接的物流公司，逐件扫包裹面单核对归属，防止串包': 'Pick the carrier you are handing to, scan each parcel to verify it belongs — no cross-carrier mix-ups',
    '当前交接给': 'Handing over to', '请先选择当前交接的物流公司': 'Select the carrier being handed to first',
    '订单数据里还没有物流公司，导入订单时请映射「物流公司」列。': 'No carrier info in your orders yet — map the carrier column when importing.',
    '扫描包裹面单运单号': 'Scan the parcel label tracking no.',
    '扫码自动确认（无需回车） · 归属正确绿灯放行，串包红灯报警': 'Scans auto-confirm · green = correct carrier, red alarm = wrong carrier',
    '等待扫描包裹面单…': 'Waiting for parcel scan…',
    '归属正确，可交接': 'Correct carrier — hand over',
    '串包警报！不要交给 {sel}': 'WRONG CARRIER! Do not give to {sel}',
    '{oc} 的包裹': '{oc} parcel', '该包裹属于【{oc}】，请取出放回对应区域。': 'This parcel belongs to {oc} — remove it and put it back in its area.',
    '✓ 正确': '✓ OK',
    '该包裹本次已扫过': 'Already scanned this session',
    '该订单未指定物流公司': 'Order has no carrier assigned',
    '导入订单时映射「物流公司」列，或在订单编辑中补填。': 'Map the carrier column on import, or fill it in when editing the order.',
    '注意：该订单尚未打包出库': 'Note: this order has not been packed/shipped yet',
    '正确': 'OK', '串包': 'Wrong carrier', '未指定': 'No carrier',
    '本次交接记录': 'This handover session', '导出交接 Excel': 'Export handover Excel',
    '所属物流': 'Belongs to', '清空': 'Clear',
    '先在左侧选择物流公司，然后逐件扫包裹面单即可。': 'Pick a carrier on the left, then scan each parcel label.',
    '物流公司（分拣核对用）': 'Carrier (for sorting check)', '物流：': 'Carrier: ',
    '多件订单逐件核对': 'Verify items on multi-item orders',
    '关闭后，多件订单扫面单也直接出库（不逐件扫商品，等同旧「扫描核对」）': 'When off, multi-item orders also ship directly on label scan (no per-item scanning)',
    '去扫码打包': 'Go pack',
    '语言': 'Language',
  },
  it: {
    ...
    '已直接完成出库：{no}': 'Spedito direttamente: {no}',
    ...
    '单件订单确认尺寸': 'Conferma misure per articolo singolo',
    '尺寸已知时一扫即发': 'Spedizione immediata se le misure sono note',
    '需先开启上一项。已记过尺寸的老 SKU 扫单直接出库不停顿，只有新 SKU 才停下来填尺寸': 'Richiede l\'opzione sopra. Gli SKU con misure salvate vengono spediti alla scansione senza fermarsi; solo i nuovi SKU si fermano per inserire le misure.',
    '单件订单扫单后确认长宽高重再出库，并按 SKU 记忆（下次自动带出）。关闭则扫单直接出库': 'Gli ordini singoli confermano L/P/H/peso prima di spedire, memorizzati per SKU (precompilati la volta dopo). Off = spedizione alla scansione.',
    '单件出库 · 请确认尺寸重量': 'Articolo singolo · conferma misure e peso',
    '↑ 已带出该商品上次尺寸，如有变化直接改（确认后覆盖记录）': '↑ Caricate le misure precedenti; modifica se cambiate (sovrascrive alla conferma)',
    '↑ 请在上方填写该商品尺寸重量，确认后记到该商品': '↑ Inserisci sopra misure e peso; salvate sull\'articolo alla conferma',
    '确认出库': 'Conferma e spedisci', '放弃': 'Annulla',
    '已带出该商品上次尺寸，确认或修改后点「确认出库」': 'Misure precedenti caricate — conferma o modifica, poi Conferma e spedisci',
    '请填写该商品尺寸重量，点「确认出库」保存': 'Inserisci misure e peso, poi Conferma e spedisci per salvare',
    '已出库并记住该商品尺寸：{no}': 'Spedito e misure salvate per l\'articolo: {no}',
    '尺寸已知，已直接出库：{no}': 'Misure note — spedito direttamente: {no}',
    '新订单响铃提醒': 'Avviso sonoro nuovi ordini',
    '同步收到别处新下的待发订单时循环响铃 + 顶部提醒条，点「接单」后停；本机自己导入的不提醒': 'Quando arrivano via sync nuovi ordini creati altrove, suona in loop + banner in alto finché non accetti; gli ordini importati qui non avvisano.',
    '有 {n} 个新订单待接单': '{n} nuovo/i ordine/i da accettare',
    '全部接单': 'Accetta tutti',
    '查看': 'Vedi',
    '静音': 'Muto',
    '已静音': 'Muto',
    '收到 {n} 个新订单，请接单': '{n} nuovo/i ordine/i ricevuto/i — accetta',
    '已接单：{no}': 'Accettato: {no}',
    '接单': 'Accetta',
    '待接单': 'Da accettare',
    '已放弃，未出库': 'Annullato — non spedito',
    '请先点「确认出库」或「放弃」处理当前包裹': 'Prima conferma o annulla il pacco corrente',
    '扫码打包页：只有 {} 件商品的订单扫面单直接出库，无需再扫商品':
    ...
    '连接后可在此选择打印机和缩放模式（直接下发助手，无需改文件）。点上方「测试连接」加载。': 'Dopo la connessione, scegli qui stampante e modalità di scala (inviate all\'agente, senza modificare file). Clicca “Prova connessione” sopra.',
    '打印机': 'Stampante', '缩放模式': 'Modalità scala', '（系统默认打印机）': '(stampante predefinita)',
    '原尺寸（最清晰）': 'Dimensione originale (nitida)', '适配居中': 'Adatta e centra', '超出缩小': 'Riduci se troppo grande',
    '保存到打印助手': 'Salva nell\'agente', '没读到打印机列表（可留系统默认）': 'Nessuna stampante rilevata (va bene la predefinita)',
    '打印机设置已保存': 'Impostazioni stampante salvate', '保存失败，请确认助手在运行': 'Salvataggio fallito — verifica che l\'agente sia attivo',
    '连不上助手，无法加载打印机列表。请先点「测试连接」确认助手在运行。': 'Agente non raggiungibile per caricare le stampanti. Clicca prima “Prova connessione”.',
    ...
    // —— 物流分拣台 ——
    '物流分拣': 'Smistamento', '物流分拣台': 'Stazione di Smistamento',
    '选定交接的物流公司，逐件扫包裹面单核对归属，防止串包': 'Scegli il corriere a cui consegni e scansiona ogni pacco per verificarne il corriere — niente scambi',
    '当前交接给': 'Consegna a', '请先选择当前交接的物流公司': 'Seleziona prima il corriere della consegna',
    '订单数据里还没有物流公司，导入订单时请映射「物流公司」列。': "Nessun corriere negli ordini — mappa la colonna corriere all'importazione.",
    '扫描包裹面单运单号': "Scansiona l'etichetta del pacco",
    '扫码自动确认（无需回车） · 归属正确绿灯放行，串包红灯报警': 'Conferma automatica · verde = corriere giusto, rosso = corriere sbagliato',
    '等待扫描包裹面单…': 'In attesa della scansione…',
    '归属正确，可交接': 'Corriere corretto — consegna',
    '串包警报！不要交给 {sel}': 'CORRIERE SBAGLIATO! Non dare a {sel}',
    '{oc} 的包裹': 'Pacco di {oc}', '该包裹属于【{oc}】，请取出放回对应区域。': 'Questo pacco è di {oc} — toglilo e rimettilo nella sua zona.',
    '✓ 正确': '✓ OK',
    '该包裹本次已扫过': 'Già scansionato in questa sessione',
    '该订单未指定物流公司': "L'ordine non ha un corriere assegnato",
    '导入订单时映射「物流公司」列，或在订单编辑中补填。': "Mappa la colonna corriere all'importazione, o compila nell'ordine.",
    '注意：该订单尚未打包出库': 'Nota: questo ordine non è ancora stato spedito',
    '正确': 'OK', '串包': 'Corriere errato', '未指定': 'Senza corriere',
    '本次交接记录': 'Sessione di consegna', '导出交接 Excel': 'Esporta Excel consegna',
    '所属物流': 'Corriere', '清空': 'Svuota',
    '先在左侧选择物流公司，然后逐件扫包裹面单即可。': 'Scegli un corriere a sinistra, poi scansiona ogni pacco.',
    '物流公司（分拣核对用）': 'Corriere (per smistamento)', '物流：': 'Corriere: ',
    '多件订单逐件核对': 'Verifica articoli per ordini multipli',
    '关闭后，多件订单扫面单也直接出库（不逐件扫商品，等同旧「扫描核对」）': 'Se disattivato, anche gli ordini multipli vengono spediti alla scansione (senza verifica articoli)',
    '去扫码打包': 'Vai a imballare',
    '语言': 'Lingua',
  }
};
