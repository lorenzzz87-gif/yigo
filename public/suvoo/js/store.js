...
function defaultDB() {
  return {
    ...
    settings: { beep: true, deduct: true, packSingleFast: true, packVerifyItems: true, printAgent: false, printAgentUrl: 'http://127.0.0.1:17777', lastBackup: null, brand: '', packAutoKnownDims: false }
  };
}
