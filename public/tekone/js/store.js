/* ============================================================
   ...
   ============================================================ */
const DB_KEY = ((typeof window !== 'undefined' && window.SUVOO_NS) || '') + 'suvoo_ims_v1';
...
function defaultDB() {
  return {
    ...
    settings: { beep: true, deduct: true, packSingleFast: true, packVerifyItems: true, printAgent: false, printAgentUrl: 'http://127.0.0.1:17777', lastBackup: null, brand: '', packAutoKnownDims: false, orderAlert: true }
  };
}
